    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('offertenr', models.CharField(default=False, max_length=30)),
                ('exactnr', models.CharField(default=False, max_length=30)),
                ('debiteurnr', models.CharField(default=False, max_length=30)),
                ('renovatie_nieuwbouw', models.CharField(default=False, max_length=15)),
                ('selectedProjectleiderAanmelder', models.IntegerField(default=False)),
                ('selectedWerkvoorbereiderAanmelder', models.IntegerField(default=False)),
                ('selectedUitvoerderAanmelder', models.IntegerField(default=False)),
                ('selectedWerkvoorbereiderFz', models.IntegerField(default=False)),
                ('selectedProjecleiderFz', models.IntegerField(default=False)),
                ('inopdrachtvoor_vloerverwarming', models.CharField(default=False, max_length=15)),
                ('onderaannemers_vloerverwarming', models.IntegerField(blank=True, default=True, null=True)),
                ('ordernr_onderaannemer_vloerverwarming', models.CharField(blank=True, default=True, max_length=15, null=True)),
                ('inopdrachtvoor_ventilatieinstallatie', models.CharField(default=False, max_length=15)),
                ('onderaannemers_ventilatieinstallatie', models.IntegerField(blank=True, default=True, null=True)),
                ('ordernr_onderaannemer_ventilatieinstallatie', models.CharField(blank=True, default=True, max_length=15, null=True)),
                ('inopdrachtvoor_zonnepanelen', models.CharField(default=False, max_length=15)),
                ('onderaannemers_zonnepanelen', models.IntegerField(blank=True, default=True, null=True)),
                ('ordernr_onderaannemer_zonnepanelen', models.CharField(blank=True, default=True, max_length=15, null=True)),
                ('datumSystemInvoer', models.CharField(default=False, max_length=30)),
